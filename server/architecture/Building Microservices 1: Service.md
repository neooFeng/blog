...
![gateway](../../_images/bms/gateway.png)
...
![gateway2](../../_images/bms/gateway2.png)
...
![principles](../../_images/bms/principles.jpg)
...
- 构建分布式系统时，业界已有很多pattern和工具，要善于利用  
  ![spring-cloud](../../_images/bms/spring-cloud.png)
- 不要盲目追求技术，适合的才是最好的
